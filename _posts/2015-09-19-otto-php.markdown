...
The PHP support is not yet good. We use <a href="https://github.com/scotch-io/scotch-box/blob/master/Vagrantfile" target="_target">Scotch Box's Vagrantfile</a> instead. We also need to create a custom Appfile which is looking like this:
