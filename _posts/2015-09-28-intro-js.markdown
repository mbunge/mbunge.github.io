...
<div class="callout callout-info">
    <h4>Tip</h4>
    <p>To find the correct bower folder, check out your .bowerrc and look for your "directory" option. If you don't have a .bowerrc file, your default folder will be _bower\_components_</p>
</div>
